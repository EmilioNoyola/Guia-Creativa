...
(57, 67, "a) Fenómeno natural", "b) Reacción química", "c) Fenómeno físico", "d) Pérdida de materia"),
...
(105, 115, "a) El número total de átomos en los reactivos es igual al número total de átomos en los productos.", "b) Se respeta la ley de la conservación de la masa.", "c) Los coeficientes estequiométricos están ajustados adecuadamente.", "d) No hay cambios en el tipo de átomos presentes en los productos y reactivos."),
...
(200, 210, "a) La estequiometría no tiene aplicaciones en la industria.", "b) La estequiometría se utiliza para calcular la cantidad de reactivo necesario para producir una cantidad específica de producto.", "c) La estequiometría solo se aplica en la investigación científica, no en la producción industrial.", "d) La estequiometría se utiliza únicamente para calcular la masa de los productos en una reacción química."),
